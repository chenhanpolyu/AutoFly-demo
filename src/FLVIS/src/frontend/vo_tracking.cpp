...
// ApproximateTime
        message_filters::Subscriber<flvis::Metadata> img1_metadata_sub;
        typedef message_filters::sync_policies::ExactTime<sensor_msgs::Image, sensor_msgs::Image, flvis::Metadata> MyApproxSyncPolicy;
  ...
  virtual void onInit()
  {
   ...
   cout << "param read successfully-1" << endl;
    ...
    Vec3 vi_para2 = Vec3(getDoubleVariableFromYaml(configFilePath,"vifusion_para4"),
                         ...
                         cout << "param read successfully-2" << endl;
    Vec6 vi_para;
    ...
    cout << "param read successfully-3" << endl;
    ...
    cout << "param read successfully-4" << endl;
    ...
    {
      cout << "going to read depth param" << endl;
      ...
      Mat4x4 mat_imu_cam  = Mat44FromYaml(configFilePath,               "T_imu_cam0");
          cout << "param read successfully" << endl;
      DepthCamera dc;
    ...
    img1_metadata_sub.subscribe(nh, "/camera/infra1/metadata", 3);
 ...
 approxSync_ = new message_filters::Synchronizer<MyApproxSyncPolicy>(MyApproxSyncPolicy(3), img0_sub, img1_sub,img1_metadata_sub);
approxSync_->registerCallback(boost::bind(&TrackingNodeletClass::image_input_callback, this, _1, _2, _3));
  ...
  void image_input_callback(const sensor_msgs::ImageConstPtr & img0_Ptr,
                                  ...
                                  const flvis::MetadataConstPtr & Metadata)
        {
            std::string if_ir_on = Metadata->json_data.substr(Metadata->json_data.find("frame_laser_power_mode")+24,1);
            // if_ir_on = "1";
            // cout<<"metadata: "<<Metadata->json_data<<endl;
            // metadata: {"frame_number":2923,"clock_domain":"global_time","frame_timestamp":1641297729753.405518,"frame_counter":2923,"hw_timestamp":107465604,"sensor_timestamp":107449615,"actual_exposure":31979,"gain_level":33,"auto_exposure":1,"time_of_arrival":1641297729761,"backend_timestamp":1641297729754,"actual_fps":30,"frame_laser_power":0,"frame_laser_power_mode":0,"exposure_priority":1,"exposure_roi_left":0,"exposure_roi_right":847,"exposure_roi_top":0,"exposure_roi_bottom":479,"frame_emitter_mode":0,"raw_frame_size":814080,"gpio_input_data":250,"sequence_name":15,"sequence_id":0,"sequence_size":2}
            // metadata: {"frame_number":2924,"clock_domain":"global_time","frame_timestamp":1641297729786.763428,"frame_counter":2924,"hw_timestamp":107498964,"sensor_timestamp":107482975,"actual_exposure":31979,"gain_level":33,"auto_exposure":1,"time_of_arrival":1641297729794,"backend_timestamp":1641297729786,"actual_fps":30,"frame_laser_power":360,"frame_laser_power_mode":1,"exposure_priority":1,"exposure_roi_left":0,"exposure_roi_right":847,"exposure_roi_top":0,"exposure_roi_bottom":479,"frame_emitter_mode":1,"raw_frame_size":814080,"gpio_input_data":250,"sequence_name":15,"sequence_id":1,"sequence_size":2}

            // cout<<"ir_state-0: "<<if_ir_on<<endl;
            if (std::stoi(if_ir_on)!=0) return;
     m_buf.lock();
