...
**ZhepeiWang0**: [汪博文章0](https://arxiv.org/pdf/2109.08403.pdf)里Section IV.D的解算算法.考虑了水平旋转对称飞机的非线性drag，并且奇点个数最少，只在完全倒立的时候有1个奇点和小推力的1个奇点.该算法处于试验阶段，支持风阻补偿，适合高速飞行和大姿态大机动飞行.
