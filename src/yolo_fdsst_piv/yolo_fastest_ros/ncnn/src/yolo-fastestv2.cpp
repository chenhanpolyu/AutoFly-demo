...
int yoloFastestv2::loadParams(bool gpu_flag, int size, float thresh1, float thresh2, float h2wRate)
{
    //if use gpu
    useGpu = gpu_flag;
    ...
    //模型输入尺寸大小
    inputWidth = size;
    inputHeight = (int)(std::round(size*h2wRate/32)*32);
    ...
    std::vector<float> bias {12.64,19.39, 37.88,51.48, 55.71,138.31, 
                             126.91,78.23, 131.57,214.55, 279.92,258.87}; //default
    //  {9.41,13.06, 15.01,20.25, 30.09,33.22, 66.85,58.63, 97.75,94.69, 146.39,169.30}; for ball
