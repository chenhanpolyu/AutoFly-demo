...
Matrix3d var_B2E(Vector3d P_E, Vector3d Eular)  //calculate the vaiance propogation matrix from B to E
{
double ii = Eular(0), jj= Eular(1), kk =  Eular(2), xb = P_E(0), yb = P_E(1),zb = P_E(2);
double Cii = cos(ii), Cjj = cos(jj), Ckk = cos(kk), Sii = sin(ii), Sjj=sin(jj),Skk = sin(kk);
Matrix3d R;
R<<((Ckk*Sjj*Cii+Skk*Sii)*yb + (-Ckk*Sjj*Sii+Skk*Cii)*zb), (-Ckk*Sjj*xb + Ckk*Cjj*Sii*yb+Ckk*Cjj*Cii*zb), (-Skk*Cjj*xb+(-Skk*Sjj*Sii-Ckk*Cii)*yb+(-Skk*Sjj*Cii+Ckk*Sii)*zb),
